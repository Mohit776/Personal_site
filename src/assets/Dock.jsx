...
function DockIcon({ children, imgSrc, className = "" }) {
  return (
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`${className}  ml-52 mt-40 transform -translate-x-1/2   flex items-end w-fit gap-4 rounded-2xl border-neutral-700 border-2 pb-2 px-4`}
      ...
      >
        {items.map((item, index) => (
          ...
          >
            <DockIcon imgSrc={item.imgSrc}>{item.icon}</DockIcon>
